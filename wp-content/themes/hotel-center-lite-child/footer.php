    ...
    <div class="footer">
        <div class="footer-wrap">
            <div class="footer-main">
                <div class="footer-main-column footer-main-column1">
                    <div class="fmc1-wrap">
                ...
                <div class="footer-main-column footer-main-column2">
                    <div class="fmc2-wrap">
                ...
                <div class="footer-main-column footer-main-column3">
                    <div class="fmc3-wrap">
                ...
                <div class="footer-main-column footer-main-column4">
                    <div class="fmc4-wrap">
                        ...
                        <div class="fmc4-icon">
                            ...
                            <div class="fmc4-content">
                                <div class="fmc4-line1"><a href="mailto:<?php echo $linkEmail; ?>"><?php echo $linkEmail; ?></a></div>
                                <div class="fmc4-line2">saigonskygarden.com.vn</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="footer-main-column footer-main-column5">
                    <div class="fmc5-wrap">
