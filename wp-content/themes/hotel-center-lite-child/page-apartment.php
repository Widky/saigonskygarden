    ...
    <div class="row position-relative apartment_frame">
        ...
        <div class="col-12 apartment_block p-xl-0">
                        ...
                        ?>
                            <div class="cat-main-title cat-studio-main-title">
                                ...
                                <h3 class="cat-title cat-studio-title">
                                    ...
                                    <?php echo get_field('apartment_subtitle_field3', $my_posts[0]->ID); ?>
                                        ...
                                        <div class="post-img-slide-wrap">
                                            <div id="carouselImgSlide" class="carousel slide" data-ride="carousel">
                                                ...
                                                <a class="carousel-control carousel-control-prev"
                                                    href="#carouselImgSlide" role="button" data-slide="prev">
                                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                                <a class="carousel-control carousel-control-next"
                                                    href="#carouselImgSlide" role="button" data-slide="next">
                                    ...
                                    <div class="csti-content post-content">
                                        <div class="csti-content-wrap">
                                            <a
                                                ...
                                                <pre
                                                    class="post-excerpt"><?php echo $my_posts[0]->post_excerpt; ?></pre>
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            ?>
                        ...
                        <div class="cat-bed-items">
                            ...
                            <div class="cat-bed-items-wrap">
                                <div class="cat-main-title cat-bed-title">
                                    <h3 class="cat-title">
                                        <?php echo "<span class='cat-title-number'>".get_field('apartment_subtitle_number_field3', $v->ID)."</span>"; echo get_field('apartment_subtitle_field3', $v->ID);?>
                                    </h3>
                                ...
                                <div class="cb-item">
                                    ...
                                    if($sliderCat && $sliderCat['img_1'] != false){
                                        ...
                                        <div class="post-img-slide-wrap">
                                            <div id="carouselImgSlide1" class="carousel slide" data-ride="carousel">
                                                ...
                                                <a class="carousel-control carousel-control-prev"
                                                    href="#carouselImgSlide1" role="button" data-slide="prev">
                                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                    <span class="sr-only">Previous</span>
                                                </a>
                                                <a class="carousel-control carousel-control-next"
                                                    href="#carouselImgSlide1" role="button" data-slide="next">
                                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                    <span class="sr-only">Next</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="cb-content post-content">
                                        <div class="cb-content-wrap">
                                            <a
                                                href="<?php echo home_url($v->post_type . '/' .$v->post_name .'.html'); ?>">
                                                <h4 class="post-title">
                ...
                <?php }else{
            $number = get_field('apartment_subtitle_number_field3', $v->ID)
                ?>
                        ...
                        <div class="cat-bed-items-wrap lor">
                            <div class="cat-main-title cat-bed-title">
                                ...
                                <h3 class="cat-title">
                                    ...
                                    <?php } 
                                    ?>
                                    <?php  echo get_field('apartment_subtitle_field3', $v->ID); ?>
                                </h3>
                            </div>
